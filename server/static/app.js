...
const LUCIDE_APP_ICONS = {
  ...
  time:'clock', date:'calendar', weather:'cloud-sun',
  stocks:'trending-up', sports:'trophy',
  countdown:'timer', world_clock:'globe',
  iss:'rocket', anim_rainbow:'rainbow', anim_sweep:'waves',
  anim_twinkle:'sparkles', anim_checker:'grid-3x3', anim_matrix:'binary',
  anim_random_spin:'shuffle',
  'word-of-the-day':'book-open',
